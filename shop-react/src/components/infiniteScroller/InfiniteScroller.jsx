...
import styled from "./infiniteScroller.module.css";
            ...
            <div className={styled.scroller}>
                <div className={styled.track}>
                    <div className={styled.item}>
                        <img src="/assets/images/adata_logo.png" alt="adata" />
                    </div>
                    <div className={styled.item}>
                        <img
                            src="/assets/images/neterbit_logo.png"
                            alt="adata"
                        />
                    </div>
                    <div className={styled.item}>
                        <img src="/assets/images/persil_logo.png" alt="adata" />
                    </div>
                    <div className={styled.item}>
                        <img src="/assets/images/pril_logo.png" alt="adata" />
                    </div>
                    <div className={styled.item}>
                        <img src="/assets/images/panter_logo.jpg" alt="adata" />
                    </div>
                    <div className={styled.item}>
                        <img
                            src="/assets/images/xvision_logo.jpg"
                            alt="adata"
                        />
                    </div>
