...
function InfiniteScroller() {
    return (
        <div className={styled.wrap_container}>
                ...
                <div className={styled.scroller}>
                    <div className={styled.track}>
                        <div className={styled.item}>
                            <img
                                src="/assets/images/adata_logo.png"
                                alt="adata"
                            />
                        </div>
                        <div className={styled.item}>
                        ...
                        <div className={styled.item}>
                            <img
                                src="/assets/images/persil_logo.png"
                                alt="adata"
                            />
                        </div>
                        <div className={styled.item}>
                            <img
                                src="/assets/images/pril_logo.png"
                                alt="adata"
                            />
                        </div>
                        <div className={styled.item}>
                            <img
                                src="/assets/images/panter_logo.jpg"
                                alt="adata"
                            />
                        </div>
                        <div className={styled.item}>
